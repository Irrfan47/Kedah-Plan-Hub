...
$db   = 'kedah_plan_hub'; // Replace with your actual database name
$user = 'kedah_user'; // Replace with your actual database username  
$pass = 'password123'; // Replace with your actual database password
